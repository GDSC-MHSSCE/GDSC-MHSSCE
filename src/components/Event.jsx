    ...
    <section className="h-full lg:h-[90vh] items-center mb-12">
      ...
      <div className="flex flex-col md:flex-row justify-end mx-auto items-center py-2 px-4 md:py-4 md:px-8 lg:py-6 lg:px-12">
        <div className="md:basis-[50%] lg:basis-[60%] text-start py-4 order-2 md:order-1 ">
          ...
          <p className="text-start text-sm md:text-sm lg:text-md mb-4">
          ...
          <h6 className="text-sm md:text-sm lg:text-md font-regular text-[#777777] mb-1">
            What will be taught in this session ?
          </h6>
          <ul className="list-disc text-sm md:text-sm lg:text-md text-regular px-4 mb-5">
          ...
          <div className="grid grid-cols-2 gap-y-4 mt-8 mx-auto justify-items-stretch">
            <div>
            ...
            <div>
              <img src={Logo} alt="GDSC MHSSCE" className=" w-40 h-12 md:w-60 md:h-12" />
            </div>
          </div>
        </div>
        <div className="w-64 md:max-w-full order-1 md:order-2 flex flex-col justify-end shadow-md h-full rounded-lg overflow-hidden md:basis-[40%] lg:basis-[30%] mx-auto mb-6 md:mb-0 text-start ">
          <div>
          ...
          <div className="bg-[#ffd3d7]  px-2 md:px-1 py-4 lg:px-6 flex flex-col space-y-6 h-full ">
            ...
            <div className="items-center mx-auto text-start space-y-1 font-regular text-xs md:text-xs lg:text-sm md:px-1 ">

      ...
      <div className="flex flex-col space-y-4 lg:space-y-0 md:max-w-lg lg:max-w-full lg:flex-row space-x-8 items-center justify-around">
        ...
        <div className="lg:py-6 lg:px-4 flex flex-col basis-[60%]  ">
          <div className="group">
            ...
            <h3 className="text-lg md:text-xl  lg:text-2xl font-medium -mt-3 mb-4 group-hover:text-blue ">
          ...
          <div className="flex space-x-2 sm:space-x-4 md:space-x-8  lg:space-x-12 ">
            ...
            >
              ...
              <span className=" relative flex flex-row space-x-1 font-medium text-[0.5rem] sm:text-xxs md:text-sm lg:text-base group-hover:text-white items-center text-center  text-[#115c9a] ">
            ...
            >
              ...
              <span className=" relative flex flex-row space-x-1 font-medium text-[0.5rem] sm:text-xxs md:text-sm lg:text-base group-hover:text-white items-center text-center  text-[#277b2a] ">
                <BsLink className="mx-auto h-4 w-4 md:h-[1.3rem] md:w-[1.3rem] items-center " />
                <p>College site</p>
              </span>
            </a>
